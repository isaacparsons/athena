...
import { CreateNewsletterItemInput, DeleteManyNewsletterItemsInput, UpdateNewsletterItemInput } from '@athena/api';
...
export declare class NewsletterItemDAO {
    ...
    get(id: number): Promise<import("@athena/api").NewsletterItem>;
