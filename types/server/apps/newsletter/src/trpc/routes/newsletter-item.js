...
const router = __1.trpc.router({
    get: __1.loggedInProcedure.input(athena_common_1.getNewsletterItemInput).query(({ input, ctx }) => {
    ...
    create: __1.loggedInProcedure.input(athena_common_1.postNewsletterItemInput).mutation(({ input, ctx }) => {
