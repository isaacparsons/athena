...
const router = __1.trpc.router({
    get: __1.loggedInProcedure.input(common_1.getInput).query((_a) => tslib_1.__awaiter(void 0, [_a], void 0, function* ({ input, ctx }) {
        return ctx.dao.newsletterItem.get(input.id);
    })),
    getItemUploadLinks: __1.loggedInProcedure
        .input(common_1.getItemUploadLinks)
        .query((_a) => tslib_1.__awaiter(void 0, [_a], void 0, function* ({ input, ctx }) {
